...
public class RegexAssignment{
    ...
    public static boolean testEmail(String email){
        return email.matches("[A-Z|a-z][\\d|[a-z]|\\-|_|\\.]*@[a-z][\\d|[a-z]|\\-|_|\\.]*\\.(com|org|net)");
    }
    ...
    public static boolean testName(String name){
        return name.matches("[A-Z]+[a-z]*(\\-[A-Z]|'[A-Z])?[a-z]* [A-Z]+[a-z]*(\\-[A-Z]|'[A-Z])?[a-z]*");
    }
    ...
    public static boolean testAddress(String address){
    	return address.matches("\\d{1,5}\\s([A-Z]|[a-z]|\\d| |\\.|-)*\\n[A-Z]([a-z]| [A-Z]|\\s|\\.|\\-[A-Z])*,?\\s[A-Z]{2}\\s\\d{5}(\\-\\d{4})?");
    }
    ...
    public static boolean testJavaExecutable(String java){
        return java.matches("public static void main\\(String\\[\\] ([a-z]|[A-Z]|\\$|\\_)+([a-z]|[A-Z]|\\$|\\_|\\d)*\\)");
    }
}